...
Next, install the [Apitally SDK](/sdk-reference/dotnet) in your project:
...
Check out the <a href="/sdk-reference/dotnet#request-logging-options">SDK reference</a> to learn more about the request logging configuration options.
