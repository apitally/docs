...
sidebarTitle: "Hono (Cloudflare Workers)"
...
Next, install the [Apitally Serverless SDK](https://www.npmjs.com/package/@apitally/serverless) in your project.
...
<Note>
  Cloudflare Logpush doesn't include requests from local development environments, so you won't see them in
