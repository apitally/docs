...
Next, install the [Apitally SDK](/sdk-reference/javascript) and the [fastify-plugin](https://www.npmjs.com/package/fastify-plugin) package in your Fastify project.
