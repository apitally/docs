...
Add the [Apitally SDK](/sdk-reference/java/v0/overview) to your project's dependencies.
...
Check out the <a href="/sdk-reference/java/v0/configuration">SDK reference</a> to learn more about the request logging configuration options.
