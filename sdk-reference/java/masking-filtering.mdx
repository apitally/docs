...
description: Learn how to mask sensitive data and exclude requests from logging with the Apitally SDK for Java.
---
...
The `Request` object passed to callback methods has the following properties:
