...
<CardGroup cols={2}>
  <Card
    ...
    href="/sdk-reference/python-serverless/v0/setup-guides/fastapi-cloudflare-workers"
  >
    Cloudflare Workers
  </Card>
  <Card
    ...
    href="/sdk-reference/javascript-serverless/v0/setup-guides/hono-cloudflare-workers"
  >
    Cloudflare Workers
  </Card>
</CardGroup>
