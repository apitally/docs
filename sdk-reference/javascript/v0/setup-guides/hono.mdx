...
Next, install the [Apitally SDK](/sdk-reference/javascript/v0/overview) in your Hono project.
...
To enable tracing, set `captureTraces` to `true` and instrument the libraries you want to trace with OpenTelemetry. See the [tracing guide](/sdk-reference/javascript/v0/tracing) for further instructions.
