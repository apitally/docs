...
Next, install the [Apitally SDK](/sdk-reference/javascript/v0/overview) and the [fastify-plugin](https://www.npmjs.com/package/fastify-plugin) package in your Fastify project.
