...
description: "Set up the Apitally SDK for your Fastify application."
---
...
This page guides you through the setup of the Apitally SDK for your [Fastify](https://fastify.dev) application. If you don't have an Apitally account yet, [sign up](https://app.apitally.io/?signup) before getting started.
...
Call `useApitally` with your Fastify application, the write token, and [other configuration options](/sdk-reference/javascript/v1/configuration) immediately after creating the app, before registering plugins and routes.
...
<CodeGroup>
```javascript preHandler hook {5-9}
