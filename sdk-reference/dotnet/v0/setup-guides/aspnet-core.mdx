...
Next, install the [Apitally SDK](/sdk-reference/dotnet/v0/overview) in your project:
...
Check out the <a href="/sdk-reference/dotnet/v0/configuration">SDK reference</a> to learn more about the request logging configuration options.
...
To enable tracing, set `CaptureTraces` to `true` and instrument the libraries you want to trace with OpenTelemetry. See the [tracing guide](/sdk-reference/dotnet/v0/tracing) for further instructions.
