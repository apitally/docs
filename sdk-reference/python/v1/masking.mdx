...
The following example callbacks mask the entire body for admin endpoints and selected fields in user profile responses:

```python Callback function examples {46-48}
import json
