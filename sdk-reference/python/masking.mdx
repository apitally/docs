...
When request logging is enabled, the Apitally SDK captures details about each request and response handled by your application. To protect sensitive data and reduce noise, the SDK provides mechanisms for masking and filtering out requests you don't want to log.
...
<Info>See the [configuration page](/sdk-reference/python/configuration) for how to apply these parameters (framework-specific).</Info>
