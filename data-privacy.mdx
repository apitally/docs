...
<AccordionGroup>
  ...
  <Accordion title="Validation error info">
    ...
    Only captured if a supported framework is used. See [here](/api-metrics/errors-dashboard#validation-errors) for details.
...
<Note>
  These exclusions don't impact metrics. If you'd like to exclude certain endpoints from metrics, you can mark them as excluded in the dashboard. See [here](/api-metrics/traffic-dashboard#exclude-endpoints) for details.
</Note>
