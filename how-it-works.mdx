...
<CardGroup cols={3}>
  <Card title="SDK for Python" icon="python" href="/sdk-reference/python/overview" />
  <Card title="SDK for Node.js" icon="node-js" href="/sdk-reference/javascript/overview" />
  <Card title="SDK for Go" icon="golang" href="/sdk-reference/go/overview" />
  <Card title="SDK for Java" icon="java" href="/sdk-reference/java/overview" />
  <Card title="SDK for .NET" icon="microsoft" href="/sdk-reference/dotnet/overview" />
</CardGroup>
...
<Note>
  The communication with Apitally happens asynchronously, so it doesn't interfere with your applications' handling of requests.
</Note>
