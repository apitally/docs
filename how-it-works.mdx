...
<CardGroup cols={3}>
  <Card title="SDK for Python" icon="python" href="/sdk-reference/python/v0/overview" />
  <Card title="SDK for Node.js" icon="node-js" href="/sdk-reference/javascript/v0/overview" />
  <Card title="SDK for Go" icon="golang" href="/sdk-reference/go/v0/overview" />
  <Card title="SDK for Java" icon="java" href="/sdk-reference/java/v0/overview" />
  <Card title="SDK for .NET" icon="microsoft" href="/sdk-reference/dotnet/v0/overview" />
</CardGroup>
...
<Note>
  Communication with Apitally happens asynchronously and doesn't interfere with your application's request handling.
</Note>
