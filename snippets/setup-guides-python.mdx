<CardGroup cols={3}>
  <Card
    ...
    href="/sdk-reference/python/v0/setup-guides/blacksheep"
  />
  <Card
    title="Django Ninja"
    icon={
    ...
    href="/sdk-reference/python/v0/setup-guides/django-ninja"
  />
  <Card
    ...
    href="/sdk-reference/python/v0/setup-guides/django-rest-framework"
  />
  <Card
    title="FastAPI"
    icon={
    ...
    href="/sdk-reference/python/v0/setup-guides/fastapi"
  />
  <Card
    title="Flask"
    icon={
    ...
    href="/sdk-reference/python/v0/setup-guides/flask"
  />
  <Card
    title="Litestar"
    icon={
    ...
    href="/sdk-reference/python/v0/setup-guides/litestar"
  />
  <Card
    title="Starlette"
    icon={
    ...
    href="/sdk-reference/python/v0/setup-guides/starlette"
  />
</CardGroup>
