...
{language == "csharp" && <p>To do this, you can provide objects of type <code>ApitallyConsumer</code>, instead of simple strings, with optional properties for a name and group.
Both should be strings with a maximum length of 64 characters.</p>}

{language == "go" && <p>To do this, you can provide a value of type <code>ApitallyConsumer</code>, instead of simple strings, with optional fields for a name and group.
Both should be strings with a maximum length of 64 characters.</p>}
