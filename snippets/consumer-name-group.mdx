...
{language == "javascript" && <p>To do this, you can provide on object of type <code>ApitallyConsumer</code>, instead of simple strings, with optional properties for a name and group.
Both should be strings with a maximum length of 64 characters.</p>}
