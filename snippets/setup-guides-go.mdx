<CardGroup cols={3}>
  <Card
    ...
    href={`/sdk-reference/go/${version}/setup-guides/chi`}
  />
  <Card
    title="Echo"
    icon={
    ...
    href={`/sdk-reference/go/${version}/setup-guides/echo`}
  />
  <Card
    title="Fiber"
    icon={
    ...
    href={`/sdk-reference/go/${version}/setup-guides/fiber`}
  />
  <Card
    title="Gin"
    icon={
    ...
    href={`/sdk-reference/go/${version}/setup-guides/gin`}
  />
</CardGroup>
