...
{language == "python" && <p>Check out the <a href="/reference/python">SDK reference</a> to learn more about the request logging configuration options.</p>}
{language == "javascript" && <p>Check out the <a href="/reference/javascript">SDK reference</a> to learn more about the request logging configuration options.</p>}
{language == "go" && <p>Check out the <a href="/reference/go">SDK reference</a> to learn more about the request logging configuration options.</p>}
