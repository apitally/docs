<CardGroup cols={3}>
  <Card
    ...
    href="/sdk-reference/python/v1/setup-guides/blacksheep"
  />
  <Card
    title="Django Ninja"
    icon={
  ...
  <Card
    ...
    href="/sdk-reference/python/v1/setup-guides/fastapi"
  />
  <Card
    title="Flask"
    icon={
    ...
    href="/sdk-reference/python/v1/setup-guides/flask"
  />
  <Card
    title="Litestar"
    icon={
    ...
    href="/sdk-reference/python/v1/setup-guides/litestar"
  />
  <Card
    title="Starlette"
    icon={
    ...
    href="/sdk-reference/python/v1/setup-guides/starlette"
  />
</CardGroup>
