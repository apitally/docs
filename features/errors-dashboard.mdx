...
<img src="https://assets.apitally.io/docs/2025-07-08/errors.webp" alt="Errors dashboard" className="rounded-xl" />
...
<div className="flex flex-row justify-between gap-4" style={{ margin: "-1rem 0" }}>
  <img src="https://assets.apitally.io/docs/2025-07-08/error-occurrences.webp" alt="Error occurrences" className="rounded" loading="lazy" />
  <img src="https://assets.apitally.io/docs/2025-07-08/error-details.webp" alt="Error details" className="rounded" loading="lazy" />
</div>
