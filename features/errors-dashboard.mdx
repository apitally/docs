...
<img src="https://assets.apitally.io/docs/2025-05-21/errors.webp" alt="Errors dashboard" class="rounded-xl" />
...
<div className="flex flex-row justify-between gap-4" style={{ margin: "-1rem 0" }}>
  <img src="https://assets.apitally.io/docs/2025-05-21/error-occurrences.webp" alt="Error occurrences" class="rounded-xl" />
  <img src="https://assets.apitally.io/docs/2025-05-21/error-details.webp" alt="Error details" class="rounded-xl" />
</div>
