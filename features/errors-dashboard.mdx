...
<img src="https://assets.apitally.io/docs/2025-08-26/errors.webp" alt="Errors dashboard" className="rounded-xl" />
...
<div className="flex flex-row justify-between gap-4" style={{ margin: "-1rem 0" }}>
  <img src="https://assets.apitally.io/docs/2025-08-26/error-occurrences.webp" alt="Error occurrences" className="rounded" loading="lazy" style={{ width: "calc(50% - 0.5rem)", height: "auto", objectFit: "contain" }} />
  <img src="https://assets.apitally.io/docs/2025-08-26/error-details.webp" alt="Error details" className="rounded" loading="lazy" style={{ width: "calc(50% - 0.5rem)", height: "auto", objectFit: "contain" }} />
</div>
