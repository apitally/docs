...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/errors-2.webp" alt="Errors dashboard" />
  </div>
</Card>
...
<CardGroup cols={2}>
  <Card>
    <div style={{ margin: "-1.5rem" }}>
      <img src="https://assets.apitally.io/docs/error-occurrences-2.webp" alt="Error occurrences" />
    </div>
  </Card>
  <Card>
    <div style={{ margin: "-1.5rem" }}>
      <img src="https://assets.apitally.io/docs/error-details-2.webp" alt="Error details" />
    </div>
  </Card>
</CardGroup>
