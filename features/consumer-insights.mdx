...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/consumers-3.webp" alt="Consumers overview" />
  </div>
</Card>
...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/create-consumer-group-2.webp" alt="Create consumer group dialog" />
  </div>
</Card>
