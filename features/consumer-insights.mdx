...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/consumers-4.webp" alt="Consumers overview" />
  </div>
</Card>
...
From there, you can navigate to different dashboards filtered to requests from a specific API consumer or consumer group.
...
If not provided by your application, a name is generated based on that identifier, but you can always change it to make it more meaningful.
...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/create-consumer-group-3.webp" alt="Create consumer group dialog" />
  </div>
</Card>
