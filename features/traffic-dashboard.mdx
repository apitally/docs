...
<img src="https://assets.apitally.io/docs/2025-11-23/traffic.webp" alt="Traffic dashboard" className="rounded-xl" />
...
<img src="https://assets.apitally.io/docs/2025-11-23/traffic-filters.webp" alt="Traffic dashboard filtering options" className="rounded-xl" loading="lazy" />
