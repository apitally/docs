...
<CardGroup cols={2}>
  <Card>
    <div style={{ margin: "-1.5rem" }}>
      <img src="https://assets.apitally.io/docs/traffic-requests-2.webp" alt="Traffic dashboard - Requests chart" />
    </div>
  </Card>
  <Card>
    <div style={{ margin: "-1.5rem" }}>
      <img src="https://assets.apitally.io/docs/traffic-requests-per-minute.webp" alt="Traffic dashboard - Requests per minute chart" />
    </div>
  </Card>
</CardGroup>
...
<Card>
  <div style={{ margin: "-1.5rem" }}>
    <img src="https://assets.apitally.io/docs/traffic-filter-2.webp" alt="Traffic dashboard filtering options" />
  </div>
</Card>
