...
description: Set thresholds for various API metrics, get notified when they are breached.
---
...
<img src="https://assets.apitally.io/docs/2025-07-08/alert-details.webp" alt="Custom alert details" className="rounded-xl" />
...
<img src="https://assets.apitally.io/docs/2025-07-08/create-alert.webp" alt="Create alert modal" className="rounded-xl" loading="lazy" />
