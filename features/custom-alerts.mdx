...
<img src="https://assets.apitally.io/docs/2025-11-23/alert-details.webp" alt="Custom alert details" className="rounded-xl" />
...
<img src="https://assets.apitally.io/docs/2025-11-23/create-alert.webp" alt="Create alert modal" className="rounded-xl" loading="lazy" />
