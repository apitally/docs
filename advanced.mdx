...
If your application makes its OpenAPI specification (often named `openapi.json`) available in an endpoint, Apitally can use that to enrich the captured metadata for your endpoints with descriptions.
