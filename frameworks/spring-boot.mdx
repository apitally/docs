...
Add the [Apitally client library for Java](https://central.sonatype.com/artifact/io.apitally/apitally) to your project's dependencies.
...
Add the `@UseApitally` annotation to your Spring Boot application class and provide the client ID for your app in the configuration.
...
<ConsumerNameGroupSnippet language="java" />
