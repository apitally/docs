...
To get started, create a new app in the [Apitally dashboard](https://app.apitally.io) and select Flask as your framework.

Install the [Apitally client library](https://pypi.org/project/apitally/) in your Starlette project (e.g. using `pip` or `poetry`) with the `flask` extra.
