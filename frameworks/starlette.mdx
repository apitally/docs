---
title: "Starlette"
description: "Set your Starlette application up to work with Apitally."
---
...
![Create app](https://raw.githubusercontent.com/apitally/assets/main/screenshots/create-app-starlette.png)

Take a note of the client ID displayed after submitting. You will need it in the next step.

## Add middleware

Next, install the [Apitally client library](https://pypi.org/project/apitally/) in your Starlette project (e.g. using `pip` or `poetry`) with the `starlette` extra.
