...
To associate requests with consumers, use the `set_consumer` function, for example in a `before_request` life cycle hook or directly in your route handler functions.
