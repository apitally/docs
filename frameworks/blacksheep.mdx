...
To associate requests with consumers, provide a <Tooltip tip="See example below">callback function</Tooltip> that takes a [`Request`](https://www.neoteroi.dev/blacksheep/requests/#the-request-class) object as an argument and returns a consumer identifier or `None`.
