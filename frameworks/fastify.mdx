...
description: "Set up your Fastify application with Apitally to monitor API requests, errors, performance and uptime."
---
...
![Create app](https://assets.apitally.io/docs/create-app-fastify.webp)
