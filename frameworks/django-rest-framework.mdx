...
This page guides you through the steps of configuring your [Django REST Framework](https://www.django-rest-framework.org) (DRF) application to work with Apitally. If you don't have an account yet, now would be a good time to [sign up](https://app.apitally.io).
...
Install the [Apitally client library](https://pypi.org/project/apitally/) in your Django project (e.g. using `pip` or `poetry`) with the `django_rest_framework` extra.
