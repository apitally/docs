...
The API also powers the [Apitally CLI](/agents/cli-and-skill), which can be used from your terminal or by coding agents.
...
- [List endpoints](/api-reference/endpoints/list-endpoints): Retrieve all API endpoints for an app.
- [Get request logs](/api-reference/request-logs/get-request-logs): Retrieve request log data for an app.
- [Get request details](/api-reference/request-logs/get-request-details): Retrieve details about a specific request.
- [Get traffic](/api-reference/metrics/get-traffic): Retrieve aggregated traffic metrics for an app.
- [Get team](/api-reference/team/get-team): Retrieve the authenticated team.
