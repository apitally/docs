...
| `maskQueryParams` | Array of regular expressions for matching query parameter names that should be masked. These are in addition to the default masking patterns. | `RegExp[]` | `[]` |
| `maskHeaders` | Array of regular expressions for matching header names that should be masked. These are in addition to the default masking patterns. | `RegExp[]` | `[]` |
| `maskBodyFields` | Array of regular expressions for matching request/response body fields that should be masked. These are in addition to the default masking patterns. | `RegExp[]` | `[]` |
