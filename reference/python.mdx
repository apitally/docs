...
| `request_logging_config` | Configuration for request logging. See table below. | `RequestLoggingConfig` |
...
| `mask_query_params` | List of regular expressions for matching query parameter names that should be masked. These are in addition to the default masking patterns. | `list[str]` | `[]` |
| `mask_headers` | List of regular expressions for matching header names that should be masked. These are in addition to the default masking patterns. | `list[str]` | `[]` |
| `mask_body_fields` | List of regular expressions for matching request/response body fields that should be masked. These are in addition to the default masking patterns. | `list[str]` | `[]` |
