...
| `MaskQueryParams` | List of regular expressions for matching query parameter names that should be masked. These are in addition to the default masking patterns. | `[]*regexp.Regexp` | `nil` |
| `MaskHeaders` | List of regular expressions for matching header names that should be masked. These are in addition to the default masking patterns. | `[]*regexp.Regexp` | `nil` |
| `MaskBodyFields` | List of regular expressions for matching request/response body fields that should be masked. These are in addition to the default masking patterns. | `[]*regexp.Regexp` | `nil` |
