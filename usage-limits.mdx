...
<Tip>You can exclude certain requests from logging using custom exclusion rules to reduce your usage and stay within quotas. Check out the [SDK reference](/sdk-reference/overview) for details.</Tip>
